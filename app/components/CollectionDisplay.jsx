        ...
        {images.length > 0 && (
          <div className="product-slideshow" style={styles.slideshow}>
            ...
            <img
              ...
              srcSet={`${images[currentImageIndex]?.url}?width=300&quality=1 300w,
                                     ${images[currentImageIndex]?.url}?width=600&quality=1 600w,
                                     ${images[currentImageIndex]?.url}?width=1200&quality=1 1200w`}
              width="180px"
              height="180px"
              loading="lazy"
              style={styles.image}
